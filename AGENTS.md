...
3. Use `nr tailwind:lint` command to check tailwind errors.
4. Use `nr typecheck` command to check type errors.
5. If any **new** errors were introduced by your edits, fix them immediately.
